...
public class BaseContractTest {
	...
	public void setup() {
		List<Product> products = Arrays.asList(
				new Product(1L, "Hulk Pop", "FU32690", "Coming in September 2018", "$ 10.99"),
				new Product(2L, "Groot with Stormbreaker Pop", "FU35773", "Coming in December 2018", "$ 10.99"),
				new Product(3L, "Bucky with weapon", "FU35775", "Coming in December 2018", "$ 10.99"));
